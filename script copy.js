...
body:not(:has(.lightbox.active)) #collection-products .card .image-slider > .decoreva-rating-row,
body:not(:has(.lightbox.active)) .featured-slider .featured-slide .featured-image-box > .decoreva-rating-row{
position:absolute !important;
top:0 !important;
left:50% !important;
...
body:not(:has(.lightbox.active)) #collection-products .card .image-slider > .decoreva-rating-row .decoreva-rating-button,
body:not(:has(.lightbox.active)) .featured-slider .featured-slide .featured-image-box > .decoreva-rating-row .decoreva-rating-button{
position:relative !important;
