/* =========================================================
    ...
    "sherawali-3": {
        ...
        variations: {
            ...
            "hanuman-1": {
                defaultVariation: "dark-brown-small",
                variations: {
                    "dark-brown-small": {
                        price: "₹299",
                        size: "Size : 3.3 × 4.6 inch Approx",
...
,
    ...
    "guruji-2": {
        ...
        /* =====================================================
           REUSABLE VARIATION CSS BRIDGE
           Uses the existing variation CSS for every future card.
           No new CSS required.
           ===================================================== */
        ...
        document.querySelectorAll(".decoreva-variation-card").forEach(function (card) {
            ...
            const amazon = card.querySelector(
                ".variation-amazon-button, .sherawali-amazon-button"
            );
            const whatsapp = card.querySelector(
                ".variation-whatsapp-button, .sherawali-whatsapp-button"
            );
            const buttons = card.querySelectorAll(
                ".variation-button, .sherawali-variation"
            );
            ...
            function applyVariation(key) {
                ...
                if (whatsapp) {
                    whatsapp.href = "https://wa.me/919582899547?text=" + encodeURIComponent("Hello DECOREVA, I want to buy " + variation.whatsapp);
                }
            ...
            buttons.forEach(function (button) {
                button.addEventListener("click", function (event) {
                    event.preventDefault();
                    event.stopPropagation();
                    applyVariation(button.dataset.variation);
                });
            });
